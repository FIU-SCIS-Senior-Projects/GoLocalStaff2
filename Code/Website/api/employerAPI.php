  ...
  */  
  function searchTalent($searchCriteria)
  {
    ...
    */
    ...
    // {
    //   echo "gender: '".$searchCriteria["gender"]."'";
    ...
    if( !empty($searchCriteria["gender"]) )
    {
      ...
      $genderSelection = $searchCriteria["gender"];

      //female          gender = 0
      if( strcasecmp($genderSelection, "Female") == 0 )
      {
        //echo "female found!!";
        $femaleValue = 0;
        $whereClause.= " AND gender='".$femaleValue."'";
      }
      //male            gender = 1
      else if( strcasecmp($genderSelection, "Male") == 0)
      {

        //echo "male found!!";
        $maleValue   = 1;
        $whereClause.= " AND gender='".$maleValue."'";
      }
      //any
      else if( strcasecmp($genderSelection, "either") == 0)
      {
        //echo "Any Gender found!!";
      }
    ...
    */
    ...
    //   {
    //     if( strcasecmp($searchCriteria["weightCondition"], "at most") == 0 )
    //     {
    //       echo "at most!!!";
    //       $whereClause.= " AND weight<='".$searchCriteria["weight"]."'";
    //     }
    //     elseif ( strcasecmp($searchCriteria["weightCondition"], "equal") == 0 )
    //     {

    //       echo "equal!!!";
    //       $whereClause.= " AND weight=='".$searchCriteria["weight"]."'";
    //     }
    //     elseif ( strcasecmp($searchCriteria["weightCondition"], "at least") == 0) 
    //     {
