 <?php
	...
	$passwordMatchError = null;
  	...
  	$uname         = trim($_POST['username']);
        ...
        $confpass      = trim($_POST['confirmPass']);
        ...
        $usertype      = $_POST['userType'];
                ...
                elseif(filter_var($email,FILTER_VALIDATE_EMAIL) == FALSE)
                  $emailerror = "Invalid email format";
                         ...
                         $res = mysql_num_rows(mysql_query("SELECT * FROM $usertype  WHERE username='$uname'"));
                         if($res!=0)
                         {
                                $exixtingUser = true;
                                $usernameError = "Username is already taken.";
                         }
                         $res = mysql_num_rows(mysql_query("SELECT * FROM $usertype WHERE email='$email'"));
                         if($res!=0)
                         {
                                $existingUser = true;
                         ...
                         if(!$existing)
                         {
                             ...
                             $message  = '
                               ...
                               http://45.55.240.59/Website/Live_Andres/verification.php?email='.$email.'&hash='.$hash.'&usertype='.$usertype.'';
                             
                             $headers  =  'From:noreply@golocal@gmail.com' ."\r\n";
                             mail($to, $subject, $message, $headers);
                             header("Location: http://45.55.240.59/Website/Live_Andres/aftersignup.php");
                         }
                }
  	}
		...
		<nav class="main-menu">
			<ul class="sf-menu">
				<li><a href="index-2.html"><em>about us</em><strong></strong></a></li>
						...
						<li><a href="index.php"><em>services</em><strong></strong></a><ul>
...
amet, consec tetuer adipiscing elit. Mauris fermentum magna. Sed laoreet aliquam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit. Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Integer rutrum ante eu lacus.</p>
			...
			<div class="wrapper"><a href="http://45.55.240.59/Website/Live_Andres/stafflogin.php">LOGIN</a>
				<div class="grid_24">
