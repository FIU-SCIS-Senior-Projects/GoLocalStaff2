...
<?php
   ...
   if(isset($_POST['submit']))
   {
     ...
     //echo "I was clicked ".$id;
     mysql_select_db("golocalapp");
     
     $x = mysql_query("DELETE  FROM registered_staff WHERE staffID = '$id'");
     echo $x;
   ...
   if(isset($_POST['submitit']))
   {
     ...
     $x = mysql_query("DELETE  FROM registered_employer WHERE employerID = '$id'");
     $row = mysql_fetch_row($x);
     if($row)
        echo "It's ".$row[0];
     //header("Location: displayAllUsers.php");     
    ...
    <div class="row">
     <div class="col-md-1"></div>
      <div class="col-lg-10">
            ...
            <button type="submit" class="btn btn-danger" aria-label="Left Align" name="submit">
            ...
            <table class="table table-striped">
             ...
             <?php
              ...
              <button type="submit" class="btn btn-danger" aria-label="Left Align" name="submitit">
                  <span class="glyphicon glyphicon-remove" aria-hidden="true"> 
                  </span>
                </button>
